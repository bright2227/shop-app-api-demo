...
class OrderItemViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_summary='列出在購物車內的所有物品資料',
    ...
    @swagger_auto_schema(
        operation_summary='讀取購物車內的特定物品資料',
        operation_description=''
    )
    ...
    @swagger_auto_schema(
        operation_summary='更改購物車內的特定物品數量',
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        operation_summary='列出所有訂單資料，包括購物車',
    ...
    @swagger_auto_schema(
        operation_summary='讀取特定訂單資料，包括購物車',
    ...
    @swagger_auto_schema(
        operation_summary='將購物車內所有產物形成訂單',
