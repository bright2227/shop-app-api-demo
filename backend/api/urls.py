...
from user.views import UserViewSet, RegisterView, VerifyEmailView, \
    RequestPasswordResetView, SetNewPasswordView, AuthGoogle, AuthGoogle2  # AuthFacebook
...
TokenObtainPairView_swagger = swagger_auto_schema(
    method='post',
    operation_summary='取得JWT Token和Refrech Token，可用於所有需要permission的api',
    operation_description='',
    security=[],)(TokenObtainPairView.as_view())
TokenRefreshView_swagger = swagger_auto_schema(
    method='post',
    operation_summary='更新JWT Token',
